...
<style>
    ...
    /* Glassmorphism Cards */
    .glass-card, div[data-testid="stVerticalBlock"]:has(> div.stElementContainer > div.stMarkdown .glass-card-marker) {
    ...
    div[data-testid="stVerticalBlock"]:has(> div.stElementContainer > div.stMarkdown .glass-card-small) {
...
if tab_selection == "🎛️ Executive Dashboard":
    ...
    with col_graphs[0]:
        with st.container():
            ...
            st.markdown('<h4>📍 Global Sourcing Distribution & Regional Risk</h4>', unsafe_allow_html=True)
    ...
    with col_graphs[1]:
        with st.container():
            st.markdown('<div class="glass-card-marker"></div>', unsafe_allow_html=True)
            st.markdown('<h4>⚠️ System Operations Log</h4>', unsafe_allow_html=True)
            st.markdown("""
...
# --- TAB 2: Risk & Sourcing Engine ---
    ...
    with col_input:
        with st.container():
            st.markdown('<div class="glass-card-marker"></div>', unsafe_allow_html=True)
            st.markdown('<h4>⚙️ Sourcing Simulator</h4>', unsafe_allow_html=True)
...
# --- TAB 3: Inventory & Commodities ---
    ...
    with col_inputs:
        with st.container():
            st.markdown('<div class="glass-card-marker"></div>', unsafe_allow_html=True)
            st.markdown('<h4>📉 Inventory Model Config</h4>', unsafe_allow_html=True)
...
"""
    ...
    with col_actions_display:
        ...
        with col_sub_1:
            with st.container():
                st.markdown('<div class="glass-card-marker glass-card-small"></div>', unsafe_allow_html=True)
                st.markdown("<h5 style='color: #fda4af; margin-bottom:12px; margin-top:0;'>⚠️ Identified Risks</h5>", unsafe_allow_html=True)
        ...
        with col_sub_2:
            with st.container():
                st.markdown('<div class="glass-card-marker glass-card-small"></div>', unsafe_allow_html=True)
                st.markdown("<h5 style='color: #06b6d4; margin-bottom:12px; margin-top:0;'>⚡ Action Items Checklist</h5>", unsafe_allow_html=True)
